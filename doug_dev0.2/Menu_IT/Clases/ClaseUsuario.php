...
Class ClaseUsuario {
    ...
    function ClaseUsuario($cedula = "", $nombre = "", $apellidos = "", $email = "", $departamento ='', 
            $localidad = '', $password = "", $rol="") 
    {
        $this->cedula = $cedula;
        $this->nombre = $nombre;
   ...
   //LOCALIDAD
    ...
    function RegistrarUsuario($cedula, $nombre, $apellidos, $email, $departamento, $localidad, $password, $rol) 
    {
        ...
        $sql = "INSERT INTO tbl_usuarios(cedula,nombre,apellidos,email,departamento,localidad,password,rol)";
        $sql .= "VALUE ('$cedula','$nombre','$apellidos','$email', '$departamento', '$localidad', $password','$rol')";
    ...
    function ActualizaUsuario($cedula_busqueda, $cedula, $nombre, $apellidos, $email, 
            $departamento, $localidad, $password, $rol) 
    {
        require "./BD/conexion.php"; // referencia de la conexion
        $retorno = array();
        $password = md5($password);
