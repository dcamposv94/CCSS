...
switch ($_POST["accion"]) {
    case "insertar":
        ...
        //$resultado = RegistrarUsuario($cedula, $nombre, $apellidos, $email, $password);

        $Usuario = new ClaseUsuario();
        $resultado = $Usuario->RegistrarUsuario($cedula, $nombre, $apellidos, $email, $password, $rol);
    ...
    case "actualizar":
        ...
        $Usuario = new ClaseUsuario();        
        $resultado = $Usuario->ActualizaUsuario($cedula_busqueda, $cedula, $nombre, $apellidos, $email, $password, $rol);
