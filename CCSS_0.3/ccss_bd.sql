...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-08-2018 a las 14:24:11
...
INSERT INTO `tbl_departamento` (`id_departamento`, `nombre_departamento`, `desc_departamento`) VALUES
(1, 'TI', 'Departamento de Tecnologias de Informacion. Encargados del control del Sistema.');
...
--
-- Volcado de datos para la tabla `tbl_localidad`
--

INSERT INTO `tbl_localidad` (`id_localidad`, `nombre_localidad`, `provincia`) VALUES
(1, 'Departamento TI Central', 'San Jose');
...
INSERT INTO `tbl_usuarios` (`cedula`, `nombre`, `apellidos`, `email`, `departamento`, `localidad`, `contrasena`, `rol`) VALUES
(115770188, 'Douglas', 'Campos Vargas', 'dcamposv94@gmail.com', 1, 1, '123', 'admin');
...
--
ALTER TABLE `tbl_usuarios`
  ADD CONSTRAINT `FK_departamento` FOREIGN KEY (`departamento`) REFERENCES `tbl_departamento` (`id_departamento`),
