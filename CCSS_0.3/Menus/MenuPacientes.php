...
<head>
    <meta charset="UTF-8">
    <title>Menu Pacientes CCSS</title>
...
<body style="background-color: #99ffff;" align="center">
    <h2>Usuario Logueado: <?php echo $_SESSION['datos-usuario']['email']; ?></h2>
    ...
    <div class="main" style="margin-left: 44%; margin-top: 2%">           
        ...
        if ($_SESSION['datos-usuario']['rol'] == 'admin') { //'admin' no es correcto, modificarlo de acuerdo al rol en BD
            ?>
            <a href="agregar-usuario.php">Agregar Paciente</a><br><br>
            <a href="eliminar-usuario.php">Eliminar Paciente</a><br><br>
            <a href="modificar-usuario.php">Modificar Paciente</a><br><br>
            <a href="buscar-usuario.php">Buscar Paciente</a><br><br>
            <a href="mostrar-usuarios.php">Ver todos los Paciente</a><br><br>
